...
public static double monthDifferenceDouble(java.util.Date dateFromX, java.util.Date dateToX){
    DBResultSet dbrs = null;
    double month=0;
    if(dateFromX==null && dateToX==null){
        return 0;
...
//                        + " - MONTH('"+Formater.formatDate(dateFromX, "yyyy-MM-dd") +"')) AS months";
		...
		String stSQL = "SELECT ((TIMESTAMPDIFF(DAY, '"+Formater.formatDate(dateFromX, "yyyy-MM-dd")+"'"
				+ ", '"+Formater.formatDate(dateToX, "yyyy-MM-dd")+"')) / 30) AS months";
        try
        {          
            dbrs = DBHandler.execQueryResult(stSQL);
            ResultSet rs = dbrs.getResultSet();            
...
public static int yearDiff(java.util.Date dateFromX, java.util.Date dateToX){
    DBResultSet dbrs = null;
    int year=0;
    if(dateFromX==null && dateToX==null){
        return 0;
...
//                        + " - MONTH('"+Formater.formatDate(dateFromX, "yyyy-MM-dd") +"')) AS months";
		...
		String stSQL = "SELECT (TIMESTAMPDIFF(YEAR, '"+Formater.formatDate(dateFromX, "yyyy-MM-dd")+"'"
				+ ", '"+Formater.formatDate(dateToX, "yyyy-MM-dd")+"')) AS year";
        try
        {          
            dbrs = DBHandler.execQueryResult(stSQL);
            ResultSet rs = dbrs.getResultSet();            
