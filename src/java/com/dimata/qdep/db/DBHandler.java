...
public class DBHandler implements I_DBType {
    ...
    //        System.getProperty("file.separator") + "harisma_vx2.xml";
    public static String CONFIG_FILE = com.dimata.RootClass.getThisClassPath() + System.getProperty("file.separator") + "env.xml";
    ...
    protected static void loadConfig_online() // for online
            throws DBException {
        if (!configLoaded) {
            //getLog();
            try {
                dbDriver = "com.mysql.jdbc.Driver";
                dbUrl = "jdbc:mysql://mysql41x.webappcabaret.net:3306/tegalsari";
                dbUser = "tegalsari";
                dbPwd = "dsj123";
    ...
    protected String getInsertSQL() {
        //System.out.println("INSERT INTO " + tableName + "(" + getFieldList(true) + ") VALUES (" + getValueList(true) + ")");
                    ...
                    if ((isForeignKey(i)) && (Integer.parseInt(s) == 0)) {
                        switch (DBSVR_TYPE) {
                            case DBSVR_ORACLE:
                                ...
                                break;
                            case DBSVR_MYSQL:
                                s = "NULL"; //Gede_28Nov2011 rubah nilai s jadi null
                                break;
    ...
    protected String getUpdateSQL() {
        //System.out.println("UPDATE " + tableName + " SET " + getFieldSetList() + " WHERE " + getKeyCondition());
    ...
    public void update()
        ...
        try {
            ...
            //System.out.println("update   "+getUpdateSQL);
        } catch (SQLException sqlexception) {
            sqlexception.printStackTrace(System.err);
            throw new DBException(this, sqlexception);
        } finally {
    ...
    public static java.util.Date convertDate(java.sql.Date date, java.sql.Time time) {
        if (date != null && time != null) {
            ...
            if (time != null) {
                ...
                java.util.Date dt = new java.util.Date(dtx.getYear(), dtx.getMonth(), dtx.getDate(),
                        time.getHours(), time.getMinutes(), time.getSeconds());
                return dt;
            }
            return null;
   ...
   public int insertWO(java.util.Date date) 
    ...
    public static int updateParsial(String sql) {
        ...
        try {
            ...
            System.err.println("\tupdate DBHandler parsial error : " + e.toString());
        } finally {
